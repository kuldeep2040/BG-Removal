...
const BgSlider = () => {
  const [sliderPosition, setSliderPosiiton] = useState(50);

  const handleSlideChanger = (e) => {
    setSliderPosiiton(e.target.value);
  };
  ...
  return (
    <div className="pb-10 md:py-20 mx-2">
      ...
      <div className="relative text-center w-full max-w-3xl overflow-hidden m-auto rounded-xl">
        <img
