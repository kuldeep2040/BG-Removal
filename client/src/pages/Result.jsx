      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-md">
        ...
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">
          ...
          <div className="left flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 overflow-hidden h-full relative bg-layer">
              <img src={assets.image_wo_bg} alt="" />
              {/* <div className="absolute right-1/2 bottom-1/2 transform translate-y-1/2 translate-x-1/2">
